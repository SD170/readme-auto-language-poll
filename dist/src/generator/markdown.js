...
var languagePoll_1 = require("./languagePoll");
// const Mustache = require('mustache');
var MUSTACHE_TEMPLATE_DIR = '/assets/templates/markdown.mustache';
var DATA = {
...
var generateReadMe = function () {
    return new Promise(function (resolve, reject) {
        fs.readFile(path_1.default.join(process.cwd() + MUSTACHE_TEMPLATE_DIR), function (err, mustacheTemplate) { return __awaiter(void 0, void 0, void 0, function () {
            var output;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (err)
                            reject(err);
                        output = mustache_1.default.render(mustacheTemplate.toString(), DATA);
                        return [4 /*yield*/, (0, languagePoll_1.generateLangBar)()];
                    case 1:
                        _a.sent();
                        fs.writeFileSync('README.md', output);
                        resolve();
